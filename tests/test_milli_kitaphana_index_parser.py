...
"""
        ...
        self.assertEqual(parsed["/tt/ssearch/detail/b"]["lang"], "arabic")

    def test_index_aggregates_languages_and_dumps_merged_result(self):
        ...
        m_merge.assert_called_once_with({"/tat": {"title": "Tat"}, "/ara": {"title": "Ara"}}, old_index)
